...
<div class="basis-64">
  ...
  >
    ...
    />
    <span
      class="text-sm text-blue-400 motion-safe:transition-colors motion-safe:duration-500 md:hidden"
      >P{playerId + 1}</span
    >
    <span
      class="text-sm text-blue-400 motion-safe:transition-colors motion-safe:duration-500 hidden md:block lg:text-4.125"
